...
const TimeLineSection = () => {
  return (
    <div className='text-black flex flex-col md:flex-row gap-4 w-[80vw] mx-auto justify-between'>
      <div className=''>
        {
      ...
      <div>
        ...
        <div className='relative w-[60%] pb-20 md:pb-0'>
            <div className='absolute -top-12 flex flex-col md:flex-row bg-[#004A32] text-white gap-6 px-8 py-4'>
