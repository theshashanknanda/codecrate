...
const CodeBanner = ({ forward, codeblock, title, description }) => {
  return (
    <div className={`flex flex-col md:flex-row gap-16 w-[90%] mx-auto p-8 ${forward ? `` : `md:flex-row-reverse`} mt-8`}>
      <div className='w-full md:w-[50%] flex flex-col gap-8 justify-start'>
