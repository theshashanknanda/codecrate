...
const Signup = () => {
    ...
    return (
        <div className="bg-richblack-900 text-white min-h-[100vh - 100px] pt-8">
          {loading ? (
            <Loader />
          ) : (
            <div className="w-[90%] md:w-[80vw] mx-auto">
              <div className="flex flex-col lg:flex-row justify-between gap-8 lg:gap-0">
                <div className="w-full lg:w-[45%]">
                  ...
                  <form onSubmit={submitHandler} className="w-full pb-4">
                    <div className="bg-[#111722] w-fit px-2 p-1 my-4 md:my-6 rounded-full flex items-center flex-row gap-2">
                      <button 
                        className={`${userType === 'Student' ? 'active' : ''} px-4 py-3 rounded-full transition-all duration-500 text-sm md:text-base`}
                        onClick={(e) => { 
                          e.preventDefault(); 
                          setUserType('Student'); 
                      ...
                      <button 
                        className={`${userType === 'Instructor' ? 'active' : ''} px-4 py-3 rounded-full transition-all duration-500 text-sm md:text-base`}
                        onClick={(e) => { 
                          e.preventDefault(); 
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-between mb-4">
                    ...
                    <button 
                      className="bg-[#CBAA0B] w-full p-2.5 md:p-3 mt-6 mb-8 rounded-md text-black text-sm pb-4 md:text-base font-medium hover:bg-[#b69909] transition-colors"
                    >
                      Create Account
                    </button>
                  </form>
